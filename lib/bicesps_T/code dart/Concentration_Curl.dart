...
class Concentration_Curl extends StatefulWidget {
  const Concentration_Curl({super.key});

  @override
  State<Concentration_Curl> createState() => _Concentration_CurlState();
}

class _Concentration_CurlState extends State<Concentration_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Concentration-Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/I_bKCYL2nL8'); // ضع رابط الفيديو هنا
                },
                child: Row(
