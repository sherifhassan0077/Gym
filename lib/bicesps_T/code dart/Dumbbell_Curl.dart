...
class Dumbbell_Curl extends StatefulWidget {
  const Dumbbell_Curl({super.key});

  @override
  State<Dumbbell_Curl> createState() => _Dumbbell_CurlState();
}

class _Dumbbell_CurlState extends State<Dumbbell_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Dumbbell_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/MCC0Wj9RErI'); // ضع رابط الفيديو هنا
                },
                child: Row(
