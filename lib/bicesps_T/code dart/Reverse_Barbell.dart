...
class Reverse_Barbell extends StatefulWidget {
  const Reverse_Barbell({super.key});

  @override
  State<Reverse_Barbell> createState() => _Reverse_BarbellState();
}

class _Reverse_BarbellState extends State<Reverse_Barbell> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Reverse_Barbell.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=nRgxYX2Ve9w&t=34s&pp=ygUPUmV2ZXJzZV9CYXJiZWxs'); // ضع رابط الفيديو هنا
                },
                child: Row(
