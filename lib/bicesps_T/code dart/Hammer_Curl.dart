...
class Hammer_Curl extends StatefulWidget {
  const Hammer_Curl({super.key});

  @override
  State<Hammer_Curl> createState() => _Hammer_CurlState();
}

class _Hammer_CurlState extends State<Hammer_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Hammer-Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=OPqe0kCxmR8&pp=ygULSGFtbWVyLUN1cmw%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
