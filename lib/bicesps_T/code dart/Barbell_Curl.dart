...
class Barbell_Curl extends StatefulWidget {
  const Barbell_Curl({super.key});

  @override
  State<Barbell_Curl> createState() => _Barbell_CurlState();
}

class _Barbell_CurlState extends State<Barbell_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Barbell_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/2ZlISIiQJ4Y?feature=share'); // ضع رابط الفيديو هنا
                },
                child: Row(
