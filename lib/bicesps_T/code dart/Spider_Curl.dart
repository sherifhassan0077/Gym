...
class Spider_Curl extends StatefulWidget {
  const Spider_Curl({super.key});

  @override
  State<Spider_Curl> createState() => _Spider_CurlState();
}

class _Spider_CurlState extends State<Spider_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Spider_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=ke2shAeQ0O8&pp=ygULU3BpZGVyX0N1cmw%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
