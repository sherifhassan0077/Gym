...
class CrossBody_Hammer_Curl extends StatefulWidget {
  const CrossBody_Hammer_Curl({super.key});

  @override
  State<CrossBody_Hammer_Curl> createState() =>
      _CrossBody_Hammer_CurlState();
}

class _CrossBody_Hammer_CurlState extends State<CrossBody_Hammer_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/CrossBody_Hammer.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=jQgl3niYeds&pp=ygUVQ3Jvc3NCb2R5X0hhbW1lcl9DdXJs'); // ضع رابط الفيديو هنا
                },
                child: Row(
