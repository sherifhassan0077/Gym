...
class Incline_Dumbbell_biceps extends StatefulWidget {
  const Incline_Dumbbell_biceps({super.key});

  @override
  State<Incline_Dumbbell_biceps> createState() =>
      _Incline_Dumbbell_bicepsState();
}

class _Incline_Dumbbell_bicepsState extends State<Incline_Dumbbell_biceps> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Incline_Dumbbell.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/iwyO2nJuG5Y'); // ضع رابط الفيديو هنا
                },
                child: Row(
