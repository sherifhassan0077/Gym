...
class Cable_Curl extends StatefulWidget {
  const Cable_Curl({super.key});

  @override
  State<Cable_Curl> createState() => _Cable_CurlState();
}

class _Cable_CurlState extends State<Cable_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Cable_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/8tCQM_Ujk7I'); // ضع رابط الفيديو هنا
                },
                child: Row(
