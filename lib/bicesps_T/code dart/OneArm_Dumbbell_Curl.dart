...
class OneArm_Dumbbell_Curl extends StatefulWidget {
  const OneArm_Dumbbell_Curl({super.key});

  @override
  State<OneArm_Dumbbell_Curl> createState() =>
      _OneArm_Dumbbell_CurlState();
}

class _OneArm_Dumbbell_CurlState extends State<OneArm_Dumbbell_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/OneArm_Dumbbell.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=k77QFFfcA8s&pp=ygUUT25lQXJtX0R1bWJiZWxsX0N1cmw%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
