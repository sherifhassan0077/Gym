...
class EZBar_Curl extends StatefulWidget {
  const EZBar_Curl({super.key});

  @override
  State<EZBar_Curl> createState() => _EZBar_CurlState();
}

class _EZBar_CurlState extends State<EZBar_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/EZ_Bar_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/KFinlAT6aEo'); // ضع رابط الفيديو هنا
                },
                child: Row(
