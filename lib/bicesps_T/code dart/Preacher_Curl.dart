...
class Preacher_Curl extends StatefulWidget {
  const Preacher_Curl({super.key});

  @override
  State<Preacher_Curl> createState() => _Preacher_CurlState();
}

class _Preacher_CurlState extends State<Preacher_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Preacher_Curl.gifqq', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=3mtXqrkbEfI&pp=ygUNUHJlYWNoZXJfQ3VybA%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
