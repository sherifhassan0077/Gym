...
class Zottman_Curl extends StatefulWidget {
  const Zottman_Curl({super.key});

  @override
  State<Zottman_Curl> createState() =>
      _Zottman_CurlState();
}

class _Zottman_CurlState extends State<Zottman_Curl> {
  final List<String> images = [
    'lib/bicesps_T/bicesps_images/Zottman_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=D7bMA4WEKMI&t=14s&pp=ygUMWm90dG1hbl9DdXJs'); // ضع رابط الفيديو هنا
                },
                child: Row(
