...
class Parallel_Bar extends StatefulWidget {
  const Parallel_Bar({super.key});

  @override
  State<Parallel_Bar> createState() => _Parallel_BarState();
}

class _Parallel_BarState extends State<Parallel_Bar> {
  final List<String> images = [
    'lib/image/chest/parallel-bar-dips.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/1_4OICx2WrY'); // ضع رابط الفيديو هنا
                },
                child: Row(
