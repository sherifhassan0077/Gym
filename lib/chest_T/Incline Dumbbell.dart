...
class fly_Incline extends StatefulWidget {
  const fly_Incline({super.key});

  @override
  State<fly_Incline> createState() => _fly_InclineState();
}

class _fly_InclineState extends State<fly_Incline> {
  final List<String> images = [
    'lib/image/chest/flat_incline_dumblle.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=cIoUZOnypS8&pp=ygULc3ZlbmQgcHJlc3M%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
