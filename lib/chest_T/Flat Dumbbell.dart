...
class Flat_Dumbbell extends StatefulWidget {
  const Flat_Dumbbell({super.key});

  @override
  State<Flat_Dumbbell> createState() => _Flat_DumbbellState();
}

class _Flat_DumbbellState extends State<Flat_Dumbbell> {
  final List<String> images = [
    'lib/image/chest/Dumbbell-Chest-Fly.webp', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/z6A4W5Dib28?feature=share'); // ضع رابط الفيديو هنا
                },
                child: Row(
