...
class Cable_Press extends StatefulWidget {
  const Cable_Press({super.key});

  @override
  State<Cable_Press> createState() => _Cable_PressState();
}

class _Cable_PressState extends State<Cable_Press> {
  final List<String> images = [
    'lib/image/chest/pronated-grip-cable-fly.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/uu_Fcp-KN-0?feature=share'); // ضع رابط الفيديو هنا
                },
                child: Row(
