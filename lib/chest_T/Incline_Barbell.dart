...
class Incline_Barbell extends StatefulWidget {
  const Incline_Barbell({super.key});

  @override
  State<Incline_Barbell> createState() => _Incline_BarbellState();
}

class _Incline_BarbellState extends State<Incline_Barbell> {
  final List<String> images = [
    'lib/image/chest/How to Perform Barbell Incline Bench Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/Gruq177Psnk'); // ضع رابط الفيديو هنا
                },
                child: Row(
