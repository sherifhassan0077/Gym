...
class Push_up extends StatefulWidget {
  const Push_up({super.key});

  @override
  State<Push_up> createState() => _Push_upState();
}

class _Push_upState extends State<Push_up> {
  final List<String> images = [
    'lib/image/chest/full-push-up.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/yQEx9OC2C3E'); // ضع رابط الفيديو هنا
                },
                child: Row(
