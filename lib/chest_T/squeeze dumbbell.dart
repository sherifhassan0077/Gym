...
class squeeze_dumbbell extends StatefulWidget {
  const squeeze_dumbbell({super.key});

  @override
  State<squeeze_dumbbell> createState() => _squeeze_dumbbellState();
}

class _squeeze_dumbbellState extends State<squeeze_dumbbell> {
  final List<String> images = [
    'lib/image/chest/dips.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=eebXpmPGy2Y&pp=ygUQc3F1ZWV6ZSBkdW1iYmVsbA%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
