...
class Chest_press extends StatefulWidget {
  const Chest_press({super.key});

  @override
  State<Chest_press> createState() => _Chest_pressState();
}

class _Chest_pressState extends State<Chest_press> {
  final List<String> images = [
    'lib/image/chest/machine-chest-press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/o0Ud3RU59hw'); // ضع رابط الفيديو هنا
                },
                child: Row(
