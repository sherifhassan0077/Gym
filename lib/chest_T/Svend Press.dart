...
class Svend_Press extends StatefulWidget {
  const Svend_Press({super.key});

  @override
  State<Svend_Press> createState() => _Svend_PressState();
}

class _Svend_PressState extends State<Svend_Press> {
  final List<String> images = [
    'lib/image/chest/svend-press-barbend-movement-gif-masters.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/1V3vpcaxRYQ?feature=share'); // ضع رابط الفيديو هنا
                },
                child: Row(
