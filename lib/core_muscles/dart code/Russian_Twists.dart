...
class Russian_Twists extends StatefulWidget {
  const Russian_Twists({super.key});

  @override
  State<Russian_Twists> createState() => _Russian_TwistsState();
}

class _Russian_TwistsState extends State<Russian_Twists> {
  final List<String> images = [
    'lib/core_muscles/images/Russian_Twists.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=wkD8rjkodUI&pp=ygUOUnVzc2lhbl9Ud2lzdHM%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
