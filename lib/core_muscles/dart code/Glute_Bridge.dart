...
class _Glute_BridgeState extends State<Glute_Bridge> {
  final List<String> images = [
    'lib/core_muscles/images/Glute_Bridge.jpg', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=YRqoIM0u0PY&t=9s&pp=ygUMR2x1dGVfQnJpZGdl'); // ضع رابط الفيديو هنا
                },
                child: Row(
