...
class Weighted_Crunch extends StatefulWidget {
  const Weighted_Crunch({super.key});

  @override
  State<Weighted_Crunch> createState() => _Weighted_CrunchState();
}

class _Weighted_CrunchState extends State<Weighted_Crunch> {
  final List<String> images = [
    'lib/core_muscles/images/Weighted-Crunch.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=6L5GptvvQaU&pp=ygUPV2VpZ2h0ZWRfQ3J1bmNo'); // ضع رابط الفيديو هنا
                },
                child: Row(
