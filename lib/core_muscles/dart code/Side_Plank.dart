...
class Side_Plank extends StatefulWidget {
  const Side_Plank({super.key});

  @override
  State<Side_Plank> createState() => _Side_PlankState();
}

class _Side_PlankState extends State<Side_Plank> {
  final List<String> images = [
    'lib/core_muscles/images/Side_Plank.webp', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/BtM0a9x1F5o'); // ضع رابط الفيديو هنا
                },
                child: Row(
