...
class Ball_Rollouts extends StatefulWidget {
  const Ball_Rollouts({super.key});

  @override
  State<Ball_Rollouts> createState() => _Ball_RolloutsState();
}

class _Ball_RolloutsState extends State<Ball_Rollouts> {
  final List<String> images = [
    'lib/core_muscles/images/Swiss Ball Rollouts.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=n6PyhehLqPI&pp=ygUTU3dpc3MgQmFsbCBSb2xsb3V0cw%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
