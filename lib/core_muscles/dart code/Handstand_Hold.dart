...
class Handstand_Hold extends StatefulWidget {
  const Handstand_Hold({super.key});

  @override
  State<Handstand_Hold> createState() => _Handstand_HoldState();
}

class _Handstand_HoldState extends State<Handstand_Hold> {
  final List<String> images = [
    'lib/core_muscles/images/Bicycle_Crunches.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/lVsTvdXWaFU'); // ضع رابط الفيديو هنا
                },
                child: Row(
