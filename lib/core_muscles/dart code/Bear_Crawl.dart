...
class Bear_Crawl extends StatefulWidget {
  const Bear_Crawl({super.key});

  @override
  State<Bear_Crawl> createState() => _Bear_CrawlState();
}

class _Bear_CrawlState extends State<Bear_Crawl> {
  final List<String> images = [
    'lib/core_muscles/images/Bear_Crawl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=780CAAkwjMo&pp=ygUKQmVhcl9DcmF3bA%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
