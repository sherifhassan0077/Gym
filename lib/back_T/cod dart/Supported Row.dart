...
class Supported_Row extends StatefulWidget {
  const Supported_Row({super.key});

  @override
  State<Supported_Row> createState() => _Supported_RowState();
}

class _Supported_RowState extends State<Supported_Row> {
  final List<String> images = [
    'lib/back_T/Chest Supported Row.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/rOO_9Ki7JA4'); // ضع رابط الفيديو هنا
                },
                child: Row(
