...
class Dumbbell_Row extends StatefulWidget {
  const Dumbbell_Row({super.key});

  @override
  State<Dumbbell_Row> createState() => _Dumbbell_RowState();
}

class _Dumbbell_RowState extends State<Dumbbell_Row> {
  final List<String> images = [
    'lib/back_T/Dumbbell Row.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/Gd6tbOnISeE'); // ضع رابط الفيديو هنا
                },
                child: Row(
