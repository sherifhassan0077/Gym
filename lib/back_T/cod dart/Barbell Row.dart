...
class Barbell_Row extends StatefulWidget {
  const Barbell_Row({super.key});

  @override
  State<Barbell_Row> createState() => _Barbell_RowState();
}

class _Barbell_RowState extends State<Barbell_Row> {
  final List<String> images = [
    'lib/back_T/Barbell Row.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/Nqh7q3zDCoQ'); // ضع رابط الفيديو هنا
                },
                child: Row(
