...
class Inverted_Rows extends StatefulWidget {
  const Inverted_Rows({super.key});

  @override
  State<Inverted_Rows> createState() => _Inverted_RowsState();
}

class _Inverted_RowsState extends State<Inverted_Rows> {
  final List<String> images = [
    'lib/back_T/Inverted Rows.jpeg', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/8cj6TPgwIMA'); // ضع رابط الفيديو هنا
                },
                child: Row(
