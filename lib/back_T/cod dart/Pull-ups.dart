...
class Pull_ups extends StatefulWidget {
  const Pull_ups({super.key});

  @override
  State<Pull_ups> createState() => _Pull_upsState();
}

class _Pull_upsState extends State<Pull_ups> {
  final List<String> images = [
    'lib/back_T/chin-ups.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/8np3vKDBJfc?feature=share'); // ضع رابط الفيديو هنا
                },
                child: Row(
