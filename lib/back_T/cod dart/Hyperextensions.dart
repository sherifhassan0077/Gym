...
class Hyperextensions extends StatefulWidget {
  const Hyperextensions({super.key});

  @override
  State<Hyperextensions> createState() => _HyperextensionsState();
}

class _HyperextensionsState extends State<Hyperextensions> {
  final List<String> images = [
    'lib/back_T/Face Pulls.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/djJbWQTwD9o'); // ضع رابط الفيديو هنا
                },
                child: Row(
