...
class Cable_Rows extends StatefulWidget {
  const Cable_Rows({super.key});

  @override
  State<Cable_Rows> createState() => _Cable_RowsState();
}

class _Cable_RowsState extends State<Cable_Rows> {
  final List<String> images = [
    'lib/back_T/Seated Cable Rows.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/fPbfYDgzIgA'); // ضع رابط الفيديو هنا
                },
                child: Row(
