...
class Leg_Extension extends StatefulWidget {
  const Leg_Extension({super.key});

  @override
  State<Leg_Extension> createState() => _Leg_ExtensionState();
}

class _Leg_ExtensionState extends State<Leg_Extension> {
  final List<String> images = [
    'lib/legs_T/legs_images/Leg_Extension.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=4ZDm5EbiFI8&pp=ygUNTGVnX0V4dGVuc2lvbg%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
