...
class Sumo_Deadlift extends StatefulWidget {
  const Sumo_Deadlift({super.key});

  @override
  State<Sumo_Deadlift> createState() => _Sumo_DeadliftState();
}

class _Sumo_DeadliftState extends State<Sumo_Deadlift> {
  final List<String> images = [
    'lib/legs_T/legs_images/Sumo_Deadlift.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=pfSMst14EFk&pp=ygUNU3Vtb19EZWFkbGlmdA%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
