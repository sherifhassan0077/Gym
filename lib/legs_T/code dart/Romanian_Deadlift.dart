...
class Romanian_Deadlift extends StatefulWidget {
  const Romanian_Deadlift({super.key});

  @override
  State<Romanian_Deadlift> createState() => _Romanian_DeadliftState();
}

class _Romanian_DeadliftState extends State<Romanian_Deadlift> {
  final List<String> images = [
    'lib/legs_T/legs_images/Romanian_Deadlift.webp', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/oQwnGfZFfzw'); // ضع رابط الفيديو هنا
                },
                child: Row(
