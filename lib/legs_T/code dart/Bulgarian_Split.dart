...
class Bulgarian_Split extends StatefulWidget {
  const Bulgarian_Split({super.key});

  @override
  State<Bulgarian_Split> createState() => _Bulgarian_SplitState();
}

class _Bulgarian_SplitState extends State<Bulgarian_Split> {
  final List<String> images = [
    'lib/legs_T/legs_images/Bulgarian_Split.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/uODWo4YqbT8'); // ضع رابط الفيديو هنا
                },
                child: Row(
