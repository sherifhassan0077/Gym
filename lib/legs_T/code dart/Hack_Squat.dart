...
class Hack_Squat extends StatefulWidget {
  const Hack_Squat({super.key});

  @override
  State<Hack_Squat> createState() => _Hack_SquatState();
}

class _Hack_SquatState extends State<Hack_Squat> {
  final List<String> images = [
    'lib/legs_T/legs_images/Hack_Squat.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/vaU2FSmUhNc'); // ضع رابط الفيديو هنا
                },
                child: Row(
