...
class Leg_Curl extends StatefulWidget {
  const Leg_Curl({super.key});

  @override
  State<Leg_Curl> createState() => _Leg_CurlState();
}

class _Leg_CurlState extends State<Leg_Curl> {
  final List<String> images = [
    'lib/legs_T/legs_images/Leg_Curl.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/V0lRk-QeNuY'); // ضع رابط الفيديو هنا
                },
                child: Row(
