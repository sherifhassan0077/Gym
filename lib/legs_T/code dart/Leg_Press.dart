...
class Leg_Press extends StatefulWidget {
  const Leg_Press({super.key});

  @override
  State<Leg_Press> createState() => _Leg_PressState();
}

class _Leg_PressState extends State<Leg_Press> {
  final List<String> images = [
    'lib/legs_T/legs_images/Deadlift.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/W4vekQUkxsg'); // ضع رابط الفيديو هنا
                },
                child: Row(
