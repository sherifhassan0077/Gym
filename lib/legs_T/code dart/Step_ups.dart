...
class Step_ups extends StatefulWidget {
  const Step_ups({super.key});

  @override
  State<Step_ups> createState() => _Step_upsState();
}

class _Step_upsState extends State<Step_ups> {
  final List<String> images = [
    'lib/legs_T/legs_images/Step_ups.jpeg', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=37tVohr7LcE&pp=ygUIU3RlcF91cHM%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
