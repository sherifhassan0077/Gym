...
class Calf_Raises extends StatefulWidget {
  const Calf_Raises({super.key});

  @override
  State<Calf_Raises> createState() => _Calf_RaisesState();
}

class _Calf_RaisesState extends State<Calf_Raises> {
  final List<String> images = [
    'lib/legs_T/legs_images/Calf_Raises.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/haHcBAd637E'); // ضع رابط الفيديو هنا
                },
                child: Row(
