...
class Pistol_Squat extends StatefulWidget {
  const Pistol_Squat({super.key});

  @override
  State<Pistol_Squat> createState() => _Pistol_SquatState();
}

class _Pistol_SquatState extends State<Pistol_Squat> {
  final List<String> images = [
    'lib/legs_T/legs_images/Pistol_Squat.jpeg', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/IfESGr170DY'); // ضع رابط الفيديو هنا
                },
                child: Row(
