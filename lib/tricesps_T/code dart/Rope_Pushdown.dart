...
class Rope_Pushdown extends StatefulWidget {
  const Rope_Pushdown({super.key});

  @override
  State<Rope_Pushdown> createState() => _Rope_PushdownState();
}

class _Rope_PushdownState extends State<Rope_Pushdown> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Rope Triceps Pushdown (Cable).jpeg', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=-xa-6cQaZKY&pp=ygUdUm9wZSBUcmljZXBzIFB1c2hkb3duIChDYWJsZSk%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
