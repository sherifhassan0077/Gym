...
class Reverse_Grip extends StatefulWidget {
  const Reverse_Grip({super.key});

  @override
  State<Reverse_Grip> createState() => _Reverse_GripState();
}

class _Reverse_GripState extends State<Reverse_Grip> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Reverse Grip Triceps Pushdown (Cable).gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/7nxChmuKC8o'); // ضع رابط الفيديو هنا
                },
                child: Row(
