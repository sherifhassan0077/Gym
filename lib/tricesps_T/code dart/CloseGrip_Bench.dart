...
class CloseGrip_Bench extends StatefulWidget {
  const CloseGrip_Bench({super.key});

  @override
  State<CloseGrip_Bench> createState() => _CloseGrip_BenchState();
}

class _CloseGrip_BenchState extends State<CloseGrip_Bench> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Close_Grip_Bench_Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/b2VciXNy_So'); // ضع رابط الفيديو هنا
                },
                child: Row(
