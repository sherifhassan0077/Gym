...
class Skull_Crushers extends StatefulWidget {
  const Skull_Crushers({super.key});

  @override
  State<Skull_Crushers> createState() => _Skull_CrushersState();
}

class _Skull_CrushersState extends State<Skull_Crushers> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Skull Crushers (Lying Triceps Extension).gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/gTrlbuuMufQ'); // ضع رابط الفيديو هنا
                },
                child: Row(
