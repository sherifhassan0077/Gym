...
class Bodyweight_Triceps extends StatefulWidget {
  const Bodyweight_Triceps({super.key});

  @override
  State<Bodyweight_Triceps> createState() => _Bodyweight_TricepsState();
}

class _Bodyweight_TricepsState extends State<Bodyweight_Triceps> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Bodyweight Triceps Extension.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/SJqX-ccDaDE'); // ضع رابط الفيديو هنا
                },
                child: Row(
