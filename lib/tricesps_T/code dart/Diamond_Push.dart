...
class Diamond_Push extends StatefulWidget {
  const Diamond_Push({super.key});

  @override
  State<Diamond_Push> createState() => _Diamond_PushState();
}

class _Diamond_PushState extends State<Diamond_Push> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Diamond Push-Ups.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/fFOH_RjxnHY'); // ضع رابط الفيديو هنا
                },
                child: Row(
