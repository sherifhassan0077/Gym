...
class Single_Arm extends StatefulWidget {
  const Single_Arm({super.key});

  @override
  State<Single_Arm> createState() => _Single_ArmState();
}

class _Single_ArmState extends State<Single_Arm> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Single-Arm Triceps Extension (Cable).gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=Cp_bShvMY4c&pp=ygUkU2luZ2xlLUFybSBUcmljZXBzIEV4dGVuc2lvbiAoQ2FibGUp'); // ضع رابط الفيديو هنا
                },
                child: Row(
