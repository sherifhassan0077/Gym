...
class OneArm_Dumbbell extends StatefulWidget {
  const OneArm_Dumbbell({super.key});

  @override
  State<OneArm_Dumbbell> createState() => _OneArm_DumbbellState();
}

class _OneArm_DumbbellState extends State<OneArm_Dumbbell> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/One-Arm Overhead Dumbbell Extension.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/ovUzr06zv8k'); // ضع رابط الفيديو هنا
                },
                child: Row(
