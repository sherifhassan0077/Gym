...
class Bench_Dips extends StatefulWidget {
  const Bench_Dips({super.key});

  @override
  State<Bench_Dips> createState() => _Bench_DipsState();
}

class _Bench_DipsState extends State<Bench_Dips> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Bench Dips.gif', // الصورة الوحيدة
  ];
