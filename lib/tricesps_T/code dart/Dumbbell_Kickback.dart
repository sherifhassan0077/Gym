...
class Dumbbell_Kickback extends StatefulWidget {
  const Dumbbell_Kickback({super.key});

  @override
  State<Dumbbell_Kickback> createState() => _Dumbbell_KickbackState();
}

class _Dumbbell_KickbackState extends State<Dumbbell_Kickback> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Dumbbell-Kickback.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/uNSk4r5D-54'); // ضع رابط الفيديو هنا
                },
                child: Row(
