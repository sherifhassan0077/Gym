...
class Triceps_Dips extends StatefulWidget {
  const Triceps_Dips({super.key});

  @override
  State<Triceps_Dips> createState() => _Triceps_DipsState();
}

class _Triceps_DipsState extends State<Triceps_Dips> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Triceps_Dips.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/9llvBAV4RHI'); // ضع رابط الفيديو هنا
                },
                child: Row(
