...
class Seated_Triceps extends StatefulWidget {
  const Seated_Triceps({super.key});

  @override
  State<Seated_Triceps> createState() => _Seated_TricepsState();
}

class _Seated_TricepsState extends State<Seated_Triceps> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Seated Triceps Press.jpeg', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/kuBA3SXTNp4'); // ضع رابط الفيديو هنا
                },
                child: Row(
