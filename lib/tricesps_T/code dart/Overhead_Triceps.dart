...
class Overhead_Triceps extends StatefulWidget {
  const Overhead_Triceps({super.key});

  @override
  State<Overhead_Triceps> createState() => _Overhead_TricepsState();
}

class _Overhead_TricepsState extends State<Overhead_Triceps> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Overhead Triceps Extension.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/SfAxwNHfMyY'); // ضع رابط الفيديو هنا
                },
                child: Row(
