...
class Machine_Dips extends StatefulWidget {
  const Machine_Dips({super.key});

  @override
  State<Machine_Dips> createState() => _Machine_DipsState();
}

class _Machine_DipsState extends State<Machine_Dips> {
  final List<String> images = [
    'lib/tricesps_T/tricesps_images/Triceps Machine Dips.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/08pJgqNRAl0'); // ضع رابط الفيديو هنا
                },
                child: Row(
