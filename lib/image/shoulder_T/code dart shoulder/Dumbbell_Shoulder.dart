...
class Dumbbell_Shoulder extends StatefulWidget {
  const Dumbbell_Shoulder({super.key});

  @override
  State<Dumbbell_Shoulder> createState() => _Dumbbell_ShoulderState();
}

class _Dumbbell_ShoulderState extends State<Dumbbell_Shoulder> {
  final List<String> images = [
    'lib/image/shoulder_T/Dumbbell-Shoulder-Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/OLePvpxQEGk'); // ضع رابط الفيديو هنا
                },
                child: Row(
