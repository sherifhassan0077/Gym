...
class Military_Press extends StatefulWidget {
  const Military_Press({super.key});

  @override
  State<Military_Press> createState() => _Military_PressState();
}

class _Military_PressState extends State<Military_Press> {
  final List<String> images = [
    'lib/image/shoulder_T/Military Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=KP1sYz2VICk&pp=ygUOTWlsaXRhcnkgUHJlc3M%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
