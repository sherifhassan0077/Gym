...
class Barbell_Shoulder extends StatefulWidget {
  const Barbell_Shoulder({super.key});

  @override
  State<Barbell_Shoulder> createState() => _Barbell_ShoulderState();
}

class _Barbell_ShoulderState extends State<Barbell_Shoulder> {
  final List<String> images = [
    'lib/image/shoulder_T/Barbell_Shoulder.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=G2qpTG1Eh40&pp=ygUQQmFyYmVsbF9TaG91bGRlcg%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
