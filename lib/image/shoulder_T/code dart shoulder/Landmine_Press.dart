...
class Landmine_Press extends StatefulWidget {
  const Landmine_Press({super.key});

  @override
  State<Landmine_Press> createState() => _Landmine_PressState();
}

class _Landmine_PressState extends State<Landmine_Press> {
  final List<String> images = [
    'lib/image/shoulder_T/Landmine_Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=39lH32_Ukos&pp=ygUOTGFuZG1pbmVfUHJlc3M%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
