...
class Lateral_Raises extends StatefulWidget {
  const Lateral_Raises({super.key});

  @override
  State<Lateral_Raises> createState() => _Lateral_RaisesState();
}

class _Lateral_RaisesState extends State<Lateral_Raises> {
  final List<String> images = [
    'lib/image/shoulder_T/Lateral Raises.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/dybxZJaWxCY'); // ضع رابط الفيديو هنا
                },
                child: Row(
