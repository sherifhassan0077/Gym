...
class Smith_Machine extends StatefulWidget {
  const Smith_Machine({super.key});

  @override
  State<Smith_Machine> createState() => _Smith_MachineState();
}

class _Smith_MachineState extends State<Smith_Machine> {
  final List<String> images = [
    'lib/image/shoulder_T/Smith Machine Shoulder Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/ZmyLFsowxsg'); // ضع رابط الفيديو هنا
                },
                child: Row(
