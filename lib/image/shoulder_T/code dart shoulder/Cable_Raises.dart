...
class Cable_Raises extends StatefulWidget {
  const Cable_Raises({super.key});

  @override
  State<Cable_Raises> createState() => _Cable_RaisesState();
}

class _Cable_RaisesState extends State<Cable_Raises> {
  final List<String> images = [
    'lib/image/shoulder_T/Cable Lateral Raises.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/494AdJ1reGk'); // ضع رابط الفيديو هنا
                },
                child: Row(
