...
class Push_Press extends StatefulWidget {
  const Push_Press({super.key});

  @override
  State<Push_Press> createState() => _Push_PressState();
}

class _Push_PressState extends State<Push_Press> {
  final List<String> images = [
    'lib/image/shoulder_T/Push Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=ZUpujXKd5sU&pp=ygUTcHVzaCBwcmVzcyBkdW1iYmVsbA%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
