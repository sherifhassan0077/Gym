...
class Bent_Over extends StatefulWidget {
  const Bent_Over({super.key});

  @override
  State<Bent_Over> createState() => _Bent_OverState();
}

class _Bent_OverState extends State<Bent_Over> {
  final List<String> images = [
    'lib/image/shoulder_T/Bent_Over.gif', // الصورة الوحيدة
  ];
