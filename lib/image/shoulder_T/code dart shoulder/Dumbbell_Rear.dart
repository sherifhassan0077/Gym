...
class Dumbbell_Rear extends StatefulWidget {
  const Dumbbell_Rear({super.key});

  @override
  State<Dumbbell_Rear> createState() => _Dumbbell_RearState();
}

class _Dumbbell_RearState extends State<Dumbbell_Rear> {
