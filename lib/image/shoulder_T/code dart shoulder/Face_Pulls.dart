...
class Face_Pulls extends StatefulWidget {
  const Face_Pulls({super.key});

  @override
  State<Face_Pulls> createState() => _Face_PullsState();
}

class _Face_PullsState extends State<Face_Pulls> {
  final List<String> images = [
    'lib/image/shoulder_T/Face Pulls.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/LJN-sT_6OYY'); // ضع رابط الفيديو هنا
                },
                child: Row(
