...
class Reverse_Deck extends StatefulWidget {
  const Reverse_Deck({super.key});

  @override
  State<Reverse_Deck> createState() => _Reverse_DeckState();
}

class _Reverse_DeckState extends State<Reverse_Deck> {
  final List<String> images = [
    'lib/image/shoulder_T/Reverse Pec Deck.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/R4a1hpzYOIc'); // ضع رابط الفيديو هنا
                },
                child: Row(
