...
class Dumbbell_Upright extends StatefulWidget {
  const Dumbbell_Upright({super.key});

  @override
  State<Dumbbell_Upright> createState() => _Dumbbell_UprightState();
}

class _Dumbbell_UprightState extends State<Dumbbell_Upright> {
  final List<String> images = [
    'lib/image/shoulder_T/Dumbbell Upright Row.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/EnLvmiqRXiQ'); // ضع رابط الفيديو هنا
                },
                child: Row(
