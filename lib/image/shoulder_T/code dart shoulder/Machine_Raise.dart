...
class Machine_Raise extends StatefulWidget {
  const Machine_Raise({super.key});

  @override
  State<Machine_Raise> createState() => _Machine_RaiseState();
}

class _Machine_RaiseState extends State<Machine_Raise> {
  final List<String> images = [
    'lib/image/shoulder_T/Machine Lateral Raise.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=xMEs3zEzS8s&pp=ygUVTWFjaGluZSBMYXRlcmFsIFJhaXNl'); // ضع رابط الفيديو هنا
                },
                child: Row(
