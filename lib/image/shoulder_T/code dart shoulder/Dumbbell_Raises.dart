...
class Dumbbell_Raises extends StatefulWidget {
  const Dumbbell_Raises({super.key});

  @override
  State<Dumbbell_Raises> createState() => _Dumbbell_RaisesState();
}

class _Dumbbell_RaisesState extends State<Dumbbell_Raises> {
  final List<String> images = [
    'lib/image/shoulder_T/Dumbbell_Lateral_Raises_muscle_worked.webp', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=XPPfnSEATJA&pp=ygUXRHVtYmJlbGxfTGF0ZXJhbF9SYWlzZXM%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
