...
class Arnold_Press extends StatefulWidget {
  const Arnold_Press({super.key});

  @override
  State<Arnold_Press> createState() => _Arnold_PressState();
}

class _Arnold_PressState extends State<Arnold_Press> {
  final List<String> images = [
    'lib/image/shoulder_T/Half-Arnold-Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=GI_SYbn_CoY&pp=ygURSGFsZi1Bcm5vbGQtUHJlc3M%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
