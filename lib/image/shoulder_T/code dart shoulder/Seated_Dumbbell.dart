...
class Seated_Dumbbell extends StatefulWidget {
  const Seated_Dumbbell({super.key});

  @override
  State<Seated_Dumbbell> createState() => _Seated_DumbbellState();
}

class _Seated_DumbbellState extends State<Seated_Dumbbell> {
  final List<String> images = [
    'lib/image/shoulder_T/Seated Dumbbell Press.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/dyv6g4xBFGU'); // ضع رابط الفيديو هنا
                },
                child: Row(
