...
class Cable_Fly extends StatefulWidget {
  const Cable_Fly({super.key});

  @override
  State<Cable_Fly> createState() => _Cable_FlyState();
}

class _Cable_FlyState extends State<Cable_Fly> {
  final List<String> images = [
    'lib/image/shoulder_T/Cable Rear Delt Fly.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/shorts/U8Y4pXZk9o4'); // ضع رابط الفيديو هنا
                },
                child: Row(
