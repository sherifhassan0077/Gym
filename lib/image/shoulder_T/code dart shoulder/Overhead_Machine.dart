...
class Overhead_Machine extends StatefulWidget {
  const Overhead_Machine({super.key});

  @override
  State<Overhead_Machine> createState() => _Overhead_MachineState();
}

class _Overhead_MachineState extends State<Overhead_Machine> {
  final List<String> images = [
    'lib/image/shoulder_T/Overhead Press Machine.gif', // الصورة الوحيدة
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  _launchUrl(
                      'https://www.youtube.com/watch?v=WvLMauqrnK8&pp=ygUWT3ZlcmhlYWQgUHJlc3MgTWFjaGluZQ%3D%3D'); // ضع رابط الفيديو هنا
                },
                child: Row(
